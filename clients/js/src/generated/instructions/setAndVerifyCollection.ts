...
> = {
  ...
  treeCreatorOrDelegate:
    | Address<TAccountTreeCreatorOrDelegate>
    | TransactionSigner<TAccountTreeCreatorOrDelegate>;
  ...
  metadata: SetAndVerifyCollectionInstructionDataArgs['metadata'];
...
>(
  ...
  SetAndVerifyCollectionInstruction<
    ...
    TAccountMerkleTree,
    TAccountPayer,
    (typeof input)['treeCreatorOrDelegate'] extends TransactionSigner<TAccountTreeCreatorOrDelegate>
...
> {
  ...
  if (!args.collection) {
    args.collection = expectAddress(accounts.collectionMint.value);
  }
